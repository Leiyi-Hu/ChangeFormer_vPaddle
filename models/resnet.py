...
from models.theseus_layer import TheseusLayer
from models.save_load import load_dygraph_pretrain, load_dygraph_pretrain_from_url
...
class ResNet(TheseusLayer):
    ...
    def __init__(self,
        ...
        for block_idx in range(len(self.block_depth)):
            ...
            if replace_stride_with_dilation[block_idx-1]:
            ...
            for i in range(self.block_depth[block_idx]):
                block_list.append(globals()[self.block_type](
                    ...
                    data_format=data_format,
                    dilation=self.dilation if i > 0 else previous_dilation))
                shortcut = True
