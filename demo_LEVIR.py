...
def get_args():
    ...
    parser.add_argument('--project_name', default='CD_ChangeFormerV6_LEVIR_b16_lr0.0001_adamw_trainval_test_200_linear_ce_multi_train_True_multi_infer_False_shuffle_AB_False_embed_dim_256', type=str)
    ...
    parser.add_argument('--checkpoint_name', default='best_ckpt.pdparam', type=str)
